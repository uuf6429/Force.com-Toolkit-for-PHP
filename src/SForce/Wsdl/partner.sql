...
CREATE TABLE `AccountFeed` (
    ...
    FOREIGN KEY (`ParentId`) REFERENCES `Account`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `AccountPartner` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`ReversePartnerId`) REFERENCES `AccountPartner`(Id)
);
...
CREATE TABLE `AdditionalNumber` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`CallCenterId`) REFERENCES `CallCenter`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ApexLog` (
    ...
    FOREIGN KEY (`LogUserId`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ApexTestQueueItem` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`ApexClassId`) REFERENCES `ApexClass`(Id),
    FOREIGN KEY (`ParentJobId`) REFERENCES `AsyncApexJob`(Id)
);
...
CREATE TABLE `ApexTestResult` (
    ...
    FOREIGN KEY (`ApexClassId`) REFERENCES `ApexClass`(Id),
    FOREIGN KEY (`AsyncApexJobId`) REFERENCES `AsyncApexJob`(Id),
    FOREIGN KEY (`QueueItemId`) REFERENCES `ApexTestQueueItem`(Id),
    FOREIGN KEY (`ApexLogId`) REFERENCES `ApexLog`(Id)
);
...
CREATE TABLE `AuthProvider` (
    ...
    FOREIGN KEY (`RegistrationHandlerId`) REFERENCES `ApexClass`(Id),
    FOREIGN KEY (`ExecutionUserId`) REFERENCES `User`(Id)
);
...
CREATE TABLE `Campaign` (
    ...
    FOREIGN KEY (`ParentId`) REFERENCES `Campaign`(Id),
    FOREIGN KEY (`OwnerId`) REFERENCES `User`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`CampaignMemberRecordTypeId`) REFERENCES `RecordType`(Id)
);
...
CREATE TABLE `Case` (
    ...
    FOREIGN KEY (`AccountId`) REFERENCES `Account`(Id),
    FOREIGN KEY (`AssetId`) REFERENCES `Asset`(Id),
    FOREIGN KEY (`ParentId`) REFERENCES `Case`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CaseContactRole` (
    ...
    `SystemModstamp` DATETIME NOT NULL,
    `IsDeleted` BIT NOT NULL,
    FOREIGN KEY (`CasesId`) REFERENCES `Case`(Id),
    FOREIGN KEY (`ContactId`) REFERENCES `Contact`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CaseTeamMember` (
    ...
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Case`(Id),
    FOREIGN KEY (`TeamTemplateMemberId`) REFERENCES `CaseTeamTemplateMember`(Id),
    FOREIGN KEY (`TeamRoleId`) REFERENCES `CaseTeamRole`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CaseTeamTemplateMember` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`TeamTemplateId`) REFERENCES `CaseTeamTemplate`(Id),
    FOREIGN KEY (`TeamRoleId`) REFERENCES `CaseTeamRole`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CategoryData` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`CategoryNodeId`) REFERENCES `CategoryNode`(Id),
    FOREIGN KEY (`RelatedSobjectId`) REFERENCES `Solution`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CollaborationGroupFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `CollaborationGroup`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CollaborationGroupMember` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`CollaborationGroupId`) REFERENCES `CollaborationGroup`(Id),
...
CREATE TABLE `CollaborationInvitation` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `CollaborationInvitation`(Id),
...
CREATE TABLE `Contact` (
    ...
    FOREIGN KEY (`MasterRecordId`) REFERENCES `Contact`(Id),
    FOREIGN KEY (`AccountId`) REFERENCES `Account`(Id),
...
CREATE TABLE `ContentDocument` (
    ...
    FOREIGN KEY (`OwnerId`) REFERENCES `User`(Id),
    FOREIGN KEY (`LatestPublishedVersionId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`ParentId`) REFERENCES `ContentWorkspace`(Id)
);
...
CREATE TABLE `ContentDocumentFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `ContentDocument`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ContentDocumentHistory` (
    ...
    `OldValue` TEXT NULL,
    `NewValue` TEXT NULL,
    FOREIGN KEY (`ContentDocumentId`) REFERENCES `ContentDocument`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ContentVersion` (
    ...
    FOREIGN KEY (`ContentDocumentId`) REFERENCES `ContentDocument`(Id),
    FOREIGN KEY (`ContentModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`OwnerId`) REFERENCES `User`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
...
CREATE TABLE `ContentWorkspace` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`DefaultRecordTypeId`) REFERENCES `RecordType`(Id)
);
...
CREATE TABLE `ContentWorkspaceDoc` (
    ...
    `IsDeleted` BIT NOT NULL,
    FOREIGN KEY (`ContentWorkspaceId`) REFERENCES `ContentWorkspace`(Id),
    FOREIGN KEY (`ContentDocumentId`) REFERENCES `ContentDocument`(Id)
);
...
CREATE TABLE `Contract` (
    ...
    `LastActivityDate` DATE NULL,
    FOREIGN KEY (`AccountId`) REFERENCES `Account`(Id),
    FOREIGN KEY (`Pricebook2Id`) REFERENCES `Pricebook2`(Id),
    FOREIGN KEY (`OwnerId`) REFERENCES `User`(Id),
    FOREIGN KEY (`CompanySignedId`) REFERENCES `User`(Id),
    FOREIGN KEY (`CustomerSignedId`) REFERENCES `Contact`(Id),
...
CREATE TABLE `ContractFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Contract`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `CustomConsoleComponent` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`VisualforcePageId`) REFERENCES `ApexPage`(Id)
);
...
CREATE TABLE `Dashboard` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RunningUserId`) REFERENCES `User`(Id)
);
...
CREATE TABLE `DashboardComponentFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `DashboardComponent`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `DashboardFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Dashboard`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `DocumentAttachmentMap` (
    ...
    `CreatedDate` DATETIME NOT NULL,
    `CreatedById` VARCHAR(18) NOT NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `EmailTemplate`(Id),
...
CREATE TABLE `EmailMessage` (
    ...
    FOREIGN KEY (`ParentId`) REFERENCES `Case`(Id),
    FOREIGN KEY (`ActivityId`) REFERENCES `Task`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`ReplyToEmailMessageId`) REFERENCES `EmailMessage`(Id)
);
...
CREATE TABLE `EmailServicesAddress` (
    ...
    `LastModifiedDate` DATETIME NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`RunAsUserId`) REFERENCES `User`(Id),
    FOREIGN KEY (`FunctionId`) REFERENCES `EmailServicesFunction`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `EmailTemplate` (
    ...
    FOREIGN KEY (`OwnerId`) REFERENCES `User`(Id),
    FOREIGN KEY (`BrandTemplateId`) REFERENCES `BrandTemplate`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `Event` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RecurrenceActivityId`) REFERENCES `Event`(Id)
);
...
CREATE TABLE `EventFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Event`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ExternalDataSource` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LargeIconId`) REFERENCES `StaticResource`(Id),
    FOREIGN KEY (`SmallIconId`) REFERENCES `StaticResource`(Id)
);
...
CREATE TABLE `FieldPermissions` (
    ...
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `PermissionSet`(Id)
);
...
CREATE TABLE `Idea` (
    ...
    FOREIGN KEY (`LastCommentId`) REFERENCES `IdeaComment`(Id),
    FOREIGN KEY (`ParentIdeaId`) REFERENCES `Idea`(Id)
);
...
CREATE TABLE `Lead` (
    ...
    `NumberofLocations__c` DECIMAL(3, 0) NULL,
    FOREIGN KEY (`MasterRecordId`) REFERENCES `Lead`(Id),
    FOREIGN KEY (`ConvertedAccountId`) REFERENCES `Account`(Id),
    FOREIGN KEY (`ConvertedContactId`) REFERENCES `Contact`(Id),
    FOREIGN KEY (`ConvertedOpportunityId`) REFERENCES `Opportunity`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`DandbCompanyId`) REFERENCES `DandBCompany`(Id)
);
...
CREATE TABLE `LeadFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Lead`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `OpportunityFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Opportunity`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `OpportunityPartner` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`ReversePartnerId`) REFERENCES `OpportunityPartner`(Id)
);
...
CREATE TABLE `Order` (
    ...
    FOREIGN KEY (`ContractId`) REFERENCES `Contract`(Id),
    FOREIGN KEY (`AccountId`) REFERENCES `Account`(Id),
    FOREIGN KEY (`CustomerAuthorizedById`) REFERENCES `Contact`(Id),
    FOREIGN KEY (`CompanyAuthorizedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`BillToContactId`) REFERENCES `Contact`(Id),
    FOREIGN KEY (`ShipToContactId`) REFERENCES `Contact`(Id),
    FOREIGN KEY (`ActivatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `OrderItem` (
    ...
    FOREIGN KEY (`OrderId`) REFERENCES `Order`(Id),
    FOREIGN KEY (`PricebookEntryId`) REFERENCES `PricebookEntry`(Id),
    FOREIGN KEY (`OriginalOrderItemId`) REFERENCES `OrderItem`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `Partner` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`ReversePartnerId`) REFERENCES `Partner`(Id)
);
...
CREATE TABLE `Period` (
    ...
    `Number` INT(9) NULL,
    FOREIGN KEY (`FiscalYearSettingsId`) REFERENCES `FiscalYearSettings`(Id)
);
...
CREATE TABLE `PermissionSet` (
    ...
    `SystemModstamp` DATETIME NOT NULL,
    `NamespacePrefix` VARCHAR(15) NULL,
    FOREIGN KEY (`UserLicenseId`) REFERENCES `UserLicense`(Id),
    FOREIGN KEY (`ProfileId`) REFERENCES `Profile`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ProcessInstance` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`ProcessDefinitionId`) REFERENCES `ProcessDefinition`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ProcessInstanceStep` (
    ...
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`ProcessInstanceId`) REFERENCES `ProcessInstance`(Id),
    FOREIGN KEY (`StepNodeId`) REFERENCES `ProcessNode`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `Product2Feed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Product2`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `QueueSobject` (
    ...
    `CreatedById` VARCHAR(18) NOT NULL,
    `SystemModstamp` DATETIME NOT NULL,
    FOREIGN KEY (`QueueId`) REFERENCES `Group`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `QuickTextHistory` (
    ...
    `OldValue` TEXT NULL,
    `NewValue` TEXT NULL,
    FOREIGN KEY (`QuickTextId`) REFERENCES `QuickText`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `QuickTextShare` (
    ...
    `LastModifiedById` VARCHAR(18) NOT NULL,
    `IsDeleted` BIT NOT NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `QuickText`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `ReportFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Report`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `SiteFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Site`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `SolutionFeed` (
    ...
    `ContentSize` INT(9) NULL,
    `InsertedById` VARCHAR(18) NULL,
    FOREIGN KEY (`ParentId`) REFERENCES `Solution`(Id),
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RelatedRecordId`) REFERENCES `ContentVersion`(Id),
    FOREIGN KEY (`InsertedById`) REFERENCES `User`(Id)
);
...
CREATE TABLE `Task` (
    ...
    FOREIGN KEY (`CreatedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`RecurrenceActivityId`) REFERENCES `Task`(Id)
);
...
CREATE TABLE `UserRole` (
    ...
    FOREIGN KEY (`ParentRoleId`) REFERENCES `UserRole`(Id),
    FOREIGN KEY (`ForecastUserId`) REFERENCES `User`(Id),
    FOREIGN KEY (`LastModifiedById`) REFERENCES `User`(Id),
    FOREIGN KEY (`PortalAccountId`) REFERENCES `Account`(Id),
    FOREIGN KEY (`PortalAccountOwnerId`) REFERENCES `User`(Id)
);
